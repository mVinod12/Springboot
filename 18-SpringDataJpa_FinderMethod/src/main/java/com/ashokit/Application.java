...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//Fetching the customers
				...
				customerService.fetchCustomersByNameAndLocation("Mahesh", "Hyderabad");
				System.out.println("3...... Finding the Customers Based on Location");
				customerService.fetchCustomersByLocationWithPagination("Hyderabad",2,1);
				System.out.println("4...... Finding the Customers Count Based On CustomerName");
				customerService.getCountOfCustomerName("Bhoopal");
				System.out.println("5...... Finding the Customers Based On BillAmount");
				customerService.fetchCustomersBetweenBillAmount(5000,25000);
