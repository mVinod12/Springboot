...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cust.setCustomerid(5544);
		cust.setName("Ramesh");
		cust.setLocation("Narsampet");
		cust.setEmailid("ramesh@gmail.com");
		cust.setContactNo("125567");
		
		Customer cust1 = new Customer();
		cust1.setCustomerid(7744);
		...
		//customerController.createNewCustomers(List.of(cust,cust1));
		...
		deleteCustomer.setCustomerid(7744);
